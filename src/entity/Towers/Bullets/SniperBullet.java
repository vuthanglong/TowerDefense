...
public class SniperBullet extends Rectangle implements Bullet, BulletsInfo {
    private double dx;
    private double dy;
    private int damage;
    private int speed;
    ...
    public SniperBullet(Tower tower, Enemy enemy) {
        super(4,4, Color.WHITE);
        setDamage(BulletsInfo.SNIPER_BULLET_DAMAGE);
        setSpeed(BulletsInfo.SNIPER_BULLET_SPEED);
        this.tower = tower;
        this.target = enemy;
